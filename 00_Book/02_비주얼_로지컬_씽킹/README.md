...
![image-20200128085049435](README.assets/image-20200128085049435.png)
...
![image-20200127125928600](README.assets/image-20200127125928600-1580171952565.png)
...
![15599B405174EA650E](README.assets/15599B405174EA650E.png)
...
- **1차 정보** : 생생한 정보
- **정량 정보** : 수치적으로 표현한 정보
- **중립 정보** : 타인(타사)이 평가하는 정보

### 6.6 한 페이지당 메시지는 하나여야 한다

- 파워포인트를 사용한다면 슬라이드 **한 장당 메시지 or 도표 하나**여야 한다.
...
## 8. 마무리하며
  ...
  오늘날 비즈니스 세계에서는 로지컬 씽킹이 '글로벌 스탠더드'라고 불릴만큼 업무를 진행하는데 필수적인 기술이라고 해도 과언이 아니다. 하지만 아무리 필수적인 기술이라고 해도 실천하지 않으면 의미가 없다. 활용할 수 있도록 단련해야한다. 이 책 **비주얼 로지컬 씽킹**은 로지컬 씽킹을 소개하면서 어떻게 활용하며 단련 방법들에 대한 힌트를 제공하고 있다. 각 장에서의 주요 사항을 요약하자면,
  ...
  **네 번째 장에서는** 이상과 현실을 올바르게 이해해야 해결책을 도출할 수 있고, **역지사지**의 시각을 가지고 **끊임없이 의심**한다면 더욱 객관적인 해결책을 제시할 수 있다고 **문제를 해결하는 과정**을 소개한다.

  **다섯 번째 장에서는** 위와 같은 과정들을 통해 결론을 도출했음에도 **한 번 더 의심**하고 본래의 목적을 잃지는 않았는지 살펴봐야 하는 **주의사항**들을 소개한다.

  **여섯 번째 장에서는** 도출된 결론으로 **자신의 의견을 효과적으로 전달**하면서 상대방을 **설득하는 방법**들을 소개하고 있다.

  **마지막 장에서는** **주체적인 자세**를 가지고 일상의 것들을 분해·분석하여 **정량화**하고 문제에 **다양한 접근**을 시도하면서 **생각의 깊이**를 늘릴 수 있는 **훈련 방법**들을 소개하고 있다.

  로지컬 씽킹은 사실 대단하고 어려운 개념이 아니다. 우리가 일상생활 속에서 알게 모르게 사용하고 있는 것들이기도 하다. 이 책은 경영학에서 파생된 생각의 방법과 표현 방법에 대해서 구체적이고, 알기 쉬운 예와 그림들로 소개해준다. 그래서, 업무에서나 일상생활 등 인생을 살아감에 있어 **로지컬 씽킹을 항상 의식하고 활용하여 행동**하면 보다 나은 결정을 하는데  큰 도움이 될 것이다.
